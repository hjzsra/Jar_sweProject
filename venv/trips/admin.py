...
class LocationHistoryAdmin(OSMGeoAdmin):
  list_display = [
    ...
    fieldsets = (
        ...
        ('Pickup Location', {
            'fields': ('pickup_location', 'pickup_location_name', 'pickup_address')
        }),
        ('Dropoff Location', {
            'fields': ('dropoff_location', 'dropoff_location_name', 'dropoff_address')
        }),
        ('Schedule', {
            'fields': (
                'scheduled_departure_time',
        ...
        ('Tracking', {
            'fields': ('current_location', 'last_location_update', 'route_deviation_count')
        }),
        ('Cancellation', {
...
class TripRequestAdmin(OSMGeoAdmin):
